...
This means one can have an always-on tanzanited instance running, and another local tanzanited/tanzanite-qt instance which connects to this node and receives blocks from it.
