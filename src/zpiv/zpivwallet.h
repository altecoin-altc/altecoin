...
#ifndef Tanzanite_ZTZTWALLET_H
#define Tanzanite_ZTZTWALLET_H
...
public:
    CzTZTWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZTZT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZTZT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
