    ...
    if (fMasterNode) {
        ...
        for (const CTransaction& txCollateral : vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Tanzanite and make it unusable. To
                stop these kinds of attacks 1 in 10 successful transactions are charged. This
                adds up to a cost of 0.001 TZT per transaction on average.
            */
            if (r <= 10) {
...
void ThreadCheckObfuScationPool()
{
    ...
    RenameThread("tanzanite-obfuscation");
