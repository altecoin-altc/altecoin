...
/** Utility functions used by the Tanzanite Qt UI.
 */
namespace GUIUtil
{
...
// Render Tanzanite addresses in monospace font
...
// Parse "tanzanite:" URI into recipient object, return true on successful parsing
