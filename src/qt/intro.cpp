...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Tanzanite Core"),
     ...
     * override -datadir in the tanzanite.conf file in the default data directory
     * (to be consistent with tanzanited behavior)
     */
