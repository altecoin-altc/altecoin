...
#include "qt/tanzanite/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/tanzanite/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(TanzaniteGUI* _window, QWidget *parent) :
