...
/* Tanzanite GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Tanzanite"
#define QAPP_ORG_DOMAIN "tanzanite.org"
#define QAPP_APP_NAME_DEFAULT "Tanzanite-Qt"
#define QAPP_APP_NAME_TESTNET "Tanzanite-Qt-testnet"
