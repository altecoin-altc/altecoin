                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzTZTPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzTZTPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzTZTPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzTZTPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Tanzanite RPC console.") + "<br>" +
