...
The script [extract-osx-sdk.sh](https://github.com/altecoin-project/altecoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
altecoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/altecoin-project/altecoin/blob/master/doc/README_osx.md) for troubleshooting tips.