...
The script [extract-osx-sdk.sh](https://github.com/tanzanite-project/tanzanite/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
tanzanite/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/tanzanite-project/tanzanite/blob/master/doc/README_osx.md) for troubleshooting tips.