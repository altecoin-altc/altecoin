Altecoin Core version *3.4.0* is now available from:  <https://github.com/altecoin-project/altecoin/releases>
...
Altecoin Core v3.4.0 is a mandatory update for all users. This release contains new consensus rules and improvements that are not backwards compatible with older versions. Users will need to update their clients before enforcement of this update goes into effect.
...
### Wallet
 ...
 - #971 `bbeabc4d63` [Wallet][zALTC] zc public spend parse crash in wallet startup. (furszy)
