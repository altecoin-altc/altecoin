Tanzanite Core version *v4.0.1* is now available from:  <https://github.com/tanzanite-project/tanzanite/releases>
...
Tanzanite Core v4.0.1 is NOT a mandatory update, and user can choose to stay with v4.0.0 if they wish. However, v4.0.1 does contain minor bug fixes and performance improvements to address feedback from the v4.0.0 version.
...
Our Regression/Functional testing suite has undergone a substantial overhaul, particularly in regards to the cached chain that can be used to speed up testing. Full details can be found in the description of [#1218](https://github.com/Tanzanite-Project/Tanzanite/pull/1218).
