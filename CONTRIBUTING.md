Contributing to Tanzanite Core
============================

The Tanzanite Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/tanzanite-project/tanzanite/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Tanzanite Core project, and is not to be
confused with overall Tanzanite Network Protocol consensus changes.

Whether a pull request is merged into Tanzanite Core rests with the project merge
...
Patches that change Tanzanite consensus rules are considerably more involved than
...
Where a patchset proposes to change the Tanzanite consensus, it must have been
...
The project leader is the release manager for each Tanzanite Core release.
