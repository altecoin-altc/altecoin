Contributing to Altecoin Core
============================

The Altecoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/altecoin-project/altecoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Altecoin Core project, and is not to be
confused with overall Altecoin Network Protocol consensus changes.

Whether a pull request is merged into Altecoin Core rests with the project merge
...
Patches that change Altecoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Altecoin consensus, it must have been
...
The project leader is the release manager for each Altecoin Core release.
