...
"""Verify that starting tanzanite with -h works as expected."""
import subprocess

from test_framework.test_framework import TanzaniteTestFramework
from test_framework.util import assert_equal

class HelpTest(TanzaniteTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tanzanite with -h for help text")
        ...
        self.log.info("Start tanzanite with -version for version information")
