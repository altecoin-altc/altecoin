...
class BudgetProposalTest(TanzaniteTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid Tanzanite address")
        assert_raises_rpc_error(-5, "Invalid Tanzanite address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 TZT allowed", self.nodes[0].preparebudget,
