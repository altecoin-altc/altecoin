...
from test_framework.tanzanite_node import TanzaniteTestNode
...
class Tanzanite_ColdStakingTest(TanzaniteTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(TanzaniteTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 TZT from the pot)
...
if __name__ == '__main__':
    Tanzanite_ColdStakingTest().main()
